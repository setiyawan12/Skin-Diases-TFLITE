package yayang.setiyawan.skin_diase.clasification
...
class Clasification(assetManager:AssetManager,modelPath:String,labelPath:String,inputSize:Int) {
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<Clasification.Recognition> {
        ...
        for (i in lableList.indices) {
            ...
            if (confidence >= THRESHOLD) {
                pq.add(Clasification.Recognition("" + i,
